...
/**
 * Created by home-pc on 2016/12/15.
 */
public class GetWeatherInfoTask extends AsyncTask<String, Void, List<Map<String,Object>>> {
    ...
    private static String key = "&key=b873ecbe87c0cee19e12ac58a9299da1";
            ...
            if (response.getStatusLine().getStatusCode()==200){
                ...
                if (jsondata.getInt("resultcode") == 200){
                    ...
                    for (int i = 0 ; i<7 ;i++){
                        ...
                        item.put("weather_id",WeathIcon.weather_icons[weather_icon]);
                        list.add(item);
                    }
                }else {
