package com.example.home_pc.myweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String cityNmae = ((TextView) seft.findViewById(R.id.city))
                        .getText().toString();
                new GetWeatherInfoTask(seft).execute(cityNmae);
            }
        });
    ...
    private void initChooseDialog(){
        ...
        province_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String province_name = city_spinner.getSelectedItem().toString();
